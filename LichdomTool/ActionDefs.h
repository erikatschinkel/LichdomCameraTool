...
(Camera_ForwardSecondary, GamepadKey::LeftThumb_YNeg)
(Camera_BackwardSecondary, GamepadKey::LeftThumb_YPos)
(Camera_LeftSecondary, GamepadKey::LeftThumb_XPos)
(Camera_RightSecondary, GamepadKey::LeftThumb_XNeg)
